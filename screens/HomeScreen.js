...
const HomeScreen = () => {
  ...
  const openModalRegister = (event) => {
    ...
    event.target.measure((fx, fy, w, h, px, py) => {
      ...
      registerScale.value = withTiming(1, {
        duration: 1000,
        easing: Easing.out(Easing.exp),
      })
    })
  ...
  // Navegación a screen de "ProfileEditingScreen"
  ...
  return (
    <View style={styles.container}>
      ...
      <Modal
        ...
        <Animated.View style={[styles.modalContent, registerAnimatedStyle]}>
          ...
          <TextInput
            style={styles.input}
            value={email}
            placeholder="welcomemeo@memeo.com"
      ...
      <TouchableOpacity style={styles.screenButton} onPress={handleEditProfile}>
        <Text style={styles.buttonText}>Botón a editar</Text>
      </TouchableOpacity>
    </View>
  )
}
